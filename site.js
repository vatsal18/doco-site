...
(() => {
  ...
  initialize().catch(()=>{characters.forEach(c=>{c.renderer.element.style.visibility='hidden';c.stage.classList.remove('is-ready');});busy(true);status('Animation could not load. Please reload.');});
})();
